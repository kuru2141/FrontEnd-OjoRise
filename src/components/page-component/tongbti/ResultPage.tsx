...
export default function ResultPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FFFDD0] flex flex-col items-center pt-10 px-4">
      ...
      <img src={`/TongBTI/${typeKey}.svg`} alt={resultInfo.tongName} className="w-44 h-auto mb-3" />
      ...
      <div className="bg-white rounded-xl shadow-md px-10 py-5 w-full max-w-lg mb-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <button className="bg-pink-500 text-white text-sm px-4 py-2 rounded-md">신청하기</button>
        </div>
      </div>

      <div className="flex flex-col gap-3 w-full max-w-xs">
        <button className="bg-pink-200 px-4 py-2 rounded-md font-semibold">
          나의 결과 공유하기
        </button>
        <button className="bg-blue-200 px-4 py-2 rounded-md font-semibold">링크 공유하기</button>
        <button
