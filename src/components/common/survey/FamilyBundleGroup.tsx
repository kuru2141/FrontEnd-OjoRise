  ...
  return (
    <RadioGroup value={data.familyBundle} onValueChange={handleValueChange}>
      <div className="flex items-center gap-3">
        <RadioGroupItem value="yes" id="familyBundle-r1" />
        <Label htmlFor="familyBundle-r1" className="text-[18px]">
          할 예정이에요
        </Label>
      </div>
      <div className="flex items-center gap-3">
        <RadioGroupItem value="no" id="familyBundle-r2" />
        <Label htmlFor="familyBundle-r2" className="text-[18px]">
          안 할 예정이에요
        </Label>
      </div>
    </RadioGroup>
