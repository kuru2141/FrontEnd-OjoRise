...
const buttonVariants = cva(
  "cursor-pointer hover:cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        banner: "shadow-xs rounded-lg text-2xl font-extrabold hover:opacity-80",
      },
      size: {
        ...
        icon: "size-9",
        survey: "h-[48px] w-[119px] rounded-[5px] shadow-md",
      },
    },
    defaultVariants: {
      variant: "default",
